...
export const CreateProjectSchema = z.object({
    ...
    (data) => !data.deadline || !data.startDate || data.deadline >= data.startDate,
    {
...
export const UpdateSchedulingConfigSchema = CreateSchedulingConfigSchema.partial();
...
export const CreateWorkingPreferencesSchema = z.object({
    ...
    (data) => !data.dailyOptimalMinutes || !data.dailyMaxMinutes || data.dailyOptimalMinutes <= data.dailyMaxMinutes,
    {
        message: "Daily optimal minutes must be less than or equal to daily max minutes",
        path: ["dailyOptimalMinutes"]
    }
);

export const UpdateWorkingPreferencesSchema = CreateWorkingPreferencesSchema.partial();


/* Excluded Period Schemas */

export const CreateExcludedPeriodSchema = z.object({
    startTime: z.coerce.date(),
    endTime: z.coerce.date(),
...
export type CreateTaskCompletionInput = z.infer<typeof CreateTaskCompletionSchema>;
export type UpdateTaskCompletionInput = z.infer<typeof UpdateTaskCompletionSchema>;
export type CreateSchedulingConfigInput = z.infer<typeof CreateSchedulingConfigSchema>;
export type UpdateSchedulingConfigInput = z.infer<typeof UpdateSchedulingConfigSchema>;
export type CreateWorkingPreferencesInput = z.infer<typeof CreateWorkingPreferencesSchema>;
export type UpdateWorkingPreferencesInput = z.infer<typeof UpdateWorkingPreferencesSchema>;
export type CreateExcludedPeriodInput = z.infer<typeof CreateExcludedPeriodSchema>;
export type UpdateExcludedPeriodInput = z.infer<typeof UpdateExcludedPeriodSchema>;
