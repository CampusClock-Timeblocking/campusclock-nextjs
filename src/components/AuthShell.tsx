...
export default function AuthShell({ path }: { path: string }) {
  ...
  return (
    <main className="relative flex min-h-[100dvh] flex-col items-center justify-center bg-black text-white">
      ...
      <header className="absolute top-0 right-0 left-0 mx-auto flex max-w-7xl items-center justify-between px-4 py-3 text-sm text-white/80">
      ...
      <section className="w-full px-4">
        <div className="mx-auto mb-6 flex max-w-md items-center justify-center gap-2">
          <span
            className="bg-gradient-to-r bg-clip-text text-3xl font-semibold text-transparent"
            style={{
        ...
        <Card className="mx-auto w-full max-w-md border-white/10 bg-white/5 shadow-2xl ring-1 ring-white/10 backdrop-blur-md">
          <CardHeader className="pb-2">
            <CardTitle className="bg-clip-text text-base text-white">
      ...
      {/* Footer kompakt */}
      <footer className="absolute right-0 bottom-0 left-0 mx-auto mb-4 flex max-w-7xl items-center justify-between px-4 text-xs text-white/60">
        <div className="flex items-center gap-2">
